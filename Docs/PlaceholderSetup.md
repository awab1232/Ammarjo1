...
This guide explains how to set up splash screens, logos, icons, and placeholders in the Ammar Store Flutter app.
...
│   ├── Ammar Store_logo.svg    # Ammar Store logo (SVG)
...
| Icon | File Path |
|------|-----------|
| Ammar Store Logo | `assets/images/Ammar Store_logo.svg` |
...
| App Logo | `assets/images/Ammar Store_logo.svg` |
