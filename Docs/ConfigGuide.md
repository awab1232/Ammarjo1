...
This guide explains how to configure the Ammar Store Flutter app for your specific needs.
...
Configure the Ammar Store API endpoint and storefront key:

**File:** `lib/core/constants/api_constants.dart`

```dart
/// Ammar Store API endpoint
const String Ammar StoreEndpoint = 'https://your-Ammar Store-domain.com/graphql';
...
2. Replace `Ammar StoreEndpoint` with your Ammar Store GraphQL endpoint
3. Replace `storefrontKey` with your storefront API key from Ammar Store Admin
...
Current default: `Ammar Store Ammar Store Laravel App`
