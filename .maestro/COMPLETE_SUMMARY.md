# 🎉 Ammar Store FLUTTER - MAESTRO E2E TEST SUITE
...
Status: Booted & Ready
App: Ammar Store Flutter (com.Ammar Store.Ammar StoreFlutter)
```
...
```bash
cd /Users/jitendra/Documents/Demo_project/ammar_store/.maestro
...
```bash
cat /Users/jitendra/Documents/Demo_project/ammar_store/.maestro/INDEX.md
```
...
- **Ammar Store E-commerce**: https://Ammar Store.com/
...
Your complete Ammar Store Flutter end-to-end test automation suite is ready!
...
Your Ammar Store Flutter test automation suite is complete and ready to use!
