...
**Ammar Store Flutter App Configuration Guide**
...
Configure the Ammar Store GraphQL API endpoint and storefront key:
...
2. Replace `Ammar StoreEndpoint` with your Ammar Store GraphQL endpoint URL
3. Replace `storefrontKey` with your storefront API key from Ammar Store Admin Panel
